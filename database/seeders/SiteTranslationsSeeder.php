...
class SiteTranslationsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $translations = [
            ['personal_cabinet', ['uz' => 'Shaxsiy kabinet', 'ru' => 'Персональный кабинет', 'en' => 'Personal cabinet']],
            ['tariffs', ['uz' => 'Tariflar', 'ru' => 'Тарифы', 'en' => 'Tariffs']],
            ['services', ['uz' => 'Xizmatlar', 'ru' => 'Услуги', 'en' => 'Services']],
            ['device', ['uz' => 'Uskunalar', 'ru' => 'Устройства', 'en' => 'Devices']],
            ['actions', ['uz' => 'Aksiyalar', 'ru' => 'Акции', 'en' => 'Promotions']],
            ['news', ['uz' => 'Yangiliklar', 'ru' => 'Новости', 'en' => 'News']],
            ['beautiful_numbers', ['uz' => "Bo'sh raqamlar", 'ru' => 'Свободные номера', 'en' => 'Free numbers']],
            ['help', ['uz' => 'Yordam', 'ru' => 'Помощь', 'en' => 'Help']],
            ['search', ['uz' => 'Qidiruv', 'ru' => 'Найти', 'en' => 'Search']],
            ...
            ['old_website', ['uz' => 'Eski sayt', 'ru' => 'Старый сайт', 'en' => 'Old website']],
            ['email_for_complaints', ['uz' => 'Shikoyat va murojaatlar uchun elektron pochta', 'ru' => ' Горячая линия для жалоб и обращений', 'en' => 'Hotline for complaints and inquiries']],
