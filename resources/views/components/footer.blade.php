                    ...
                    <div class="new-footer__menu-wrap">
                        <div class="new-footer__menu-column">
                            ...
                            <div class="new-footer__menu-list">
                                <ul>
                                    <li>
                                        <a href="#" class="footer_menu_class"> Qamrov zonasi </a>
                                    </li>
                                    <li>
                                        <a href="#" class="footer_menu_class"> Sotuv ofislari </a>
                                    </li>
                                    <li>
                                        <a href="#" class="footer_menu_class"> Shaxsiy kabinet </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <ul>
                                    <li>
                                        <a href="#" class="footer_menu_class"
                                           link="http://www.perfectum.uz/tariffs"> Tariflar
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="footer_menu_class"> Korporativ mijozlarga </a>
                                    </li>
                                    <li>
                                        <a href="#" class="footer_menu_class">
                                            Xizmatlar
                                    ...
                                    <li>
                                        <a href="#" class="footer_menu_class"> Bo`sh raqamlar </a>
                                    </li>
                                    <li>
                                        <a href="#" class="footer_menu_class"> Uskunalar </a>
                                    </li>
                                    <li>
                                        <a href="#" class="footer_menu_class"> Bugun sotuvda </a>
                                    </li>
                                    <li>
                                        <a href="#" class="footer_menu_class"> Qamrov hududi </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="new-footer__menu-column">
                            ...
                            <div class="new-footer__menu-list">
                                <ul>
                                    ...
                                    <li>
                                        <a href="#" class="footer_menu_class"> Yangiliklar
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="footer_menu_class">
                                    ...
                                    <li>
                                        <a href="#" class="footer_menu_class"> Qanday ulanish kerak </a>
                                    </li>
                                    <li>
                                        <a href="#" class="footer_menu_class"> Bilish foydali </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
