...
class ActionsSeeder extends Seeder
{
    ...
    /**
     * Move a legacy `images/<basename>` file into the new
     * `uploads/images/actions/Y/m/<basename>` layout. Returns the target
     * path if the file is present, or null if it was missing.
     */
