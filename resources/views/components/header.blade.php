                                        ...
                                        <svg width="16" height="16" viewbox="0 0 16 16" fill="none"
                                            ...
                                            <g clip-path="url(#clip0_4008_1099)">
                                                <path
                                                    ...
                                                    fill="#9BA1B9"></path>
                                                <path
                                                    d="M9.70288 0C11.2399 1.84175 12.7399 4.46775 12.9489 7H15.9999C15.5994 3.79875 12.9529 0.96875 9.70288 0Z"
                                                    fill="#9BA1B9"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    fill="#9BA1B9"></path>
                                                <path
                                                    d="M16.0001 9H12.9494C12.7404 11.5322 11.2404 14.1582 9.70337 16C13.0001 15.0312 15.5996 12.2013 16.0001 9Z"
                                                    fill="#9BA1B9"></path>
                                            </g>
                                            <defs>
